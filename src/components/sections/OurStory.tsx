        ...
        <div className="flex flex-col items-center justify-center pt-[84px] pb-[86px] lg:pt-[105px] lg:pb-[73px] gap-[66px] lg:gap-[60px]">
            ...
            <div className="mt-[35px] lg:mt-[59px] flex flex-col items-center justify-center gap-[20px] lg:gap-[45px]">
              ...
              >
                <p className="font-quattrocento text-[12px] lg:text-[18px] text-[#37546B] leading-[20px] lg:leading-[32px]">
                  ...
                  started as easy laughter and{" "}
                  <br className="block lg:hidden" />
                  simple moments slowly became{" "}
              ...
              >
                <p className="font-quattrocento text-[12px] lg:text-[18px] text-[#37546B] leading-[20px] lg:leading-[32px]">
                  ...
                  <br className="hidden lg:block" />
                  that God was writing <br className="block lg:hidden" />a story
                  far greater than anything we could have{" "}
                  <br className="hidden lg:block" />
          ...
          >
            ...
            <motion.div
              ...
              className="absolute top-[15px] left-[-10px] lg:top-[30px] lg:left-[43px] z-[5] w-[251px] lg:w-[364px]"
            >
              <Image
                src="/images/OurStory/Couple1.webp"
                alt="Foto 1"
                width={364}
                height={364}
                className="w-full"
            ...
            <motion.div
              variants={fadeIn}
              transition={{ duration: 1.2, ease: "easeIn" }}
              className="absolute top-[-17px] right-[-10px] lg:top-[-17px] lg:right-[46px] z-[3] w-[225px] lg:w-[326px]"
            >
              <Image
                src="/images/OurStory/Couple2.webp"
                alt="Foto 2"
                width={326}
                height={326}
                className="w-full"
            ...
            <motion.div
              variants={fadeIn}
              transition={{ duration: 1.2, ease: "easeIn" }}
              className="absolute top-[139px] right-[50px] lg:top-[210px] lg:right-[133px] z-[4] w-[230px] lg:w-[334px]"
            >
              <Image
                src="/images/OurStory/Couple3.webp"
                alt="Foto 3"
                width={334}
                height={334}
                className="w-full"
            ...
            <motion.div
              variants={fadeIn}
              transition={{ duration: 1, ease: "easeIn" }}
              className="absolute top-[218px] right-[10px] lg:top-[328px] lg:right-[75px] z-[4] w-[178px] lg:w-[258px]"
            >
              <Image
            ...
            <motion.div
              variants={fadeIn}
              transition={{ duration: 1, ease: "easeIn" }}
              className="absolute top-[290px] left-[125px] lg:top-[435px] lg:left-[245px] z-[4] w-[78px] lg:w-[114px]"
            >
              <Image
                src="/images/OurStory/Mawar.svg"
                alt="Ornament"
                width={114}
                height={114}
                className="w-full"
            ...
            <motion.div
              variants={fadeIn}
              transition={{ duration: 1, ease: "easeIn" }}
              className="absolute top-[322px] left-[170px] lg:top-[480px] lg:left-[310px] z-[4] w-[45px] lg:w-[66px]"
            >
              <Image
            ...
            <motion.div
              variants={fadeIn}
              transition={{ duration: 1, ease: "easeIn" }}
              className="absolute top-[224px] left-[98px] lg:top-[330px] lg:left-[205px] w-[111px] lg:w-[161px]"
            >
              <Image
            ...
            <motion.div
              variants={fadeIn}
              transition={{ duration: 1, ease: "easeIn" }}
              className="absolute top-[105px] right-[-12px] lg:top-[165px] lg:right-[42px] z-[4] w-[127px] lg:w-[184px]"
            >
              <Image
            ...
            <motion.div
              variants={fadeIn}
              transition={{ duration: 1, ease: "easeIn" }}
              className="absolute top-[10px] right-[118px] lg:top-[43px] lg:right-[232px] z-[6] w-[154px] lg:w-[224px]"
            >
              <Image
