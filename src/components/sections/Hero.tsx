      ...
      >
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-start mt-[108px] lg:mt-[200px] mr-[10px] px-2">
            <p className="font-quattrocento text-[12px] lg:text-[18px] text-center text-[#37546B] leading-[14px] lg:leading-[23px] mt-2 lg:mt-0">
              PLEASE JOIN US <br className="block lg:hidden" /> 
              FOR<br className="hidden lg:block" />THE  <br className="block lg:hidden" />
              ENGAGEMENT<br />CELEBRATION OF
            </p>
            <div className="flex flex-col items-center justify-center gap-[6px] lg:gap-[15px] leading-none mt-[13px] lg:mt-[33px]">
            ...
            <p className="font-quattrocento text-[12px] lg:text-[18px] text-center text-[#37546B] mt-[8px] lg:mt-[15px]">JULY 11TH 2026</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center leading-[13px] lg:leading-[24px]">
            <p className="font-quattrocento text-[12px] lg:text-[18px] text-center text-[#37546B] mt-2 lg:mt-2">
